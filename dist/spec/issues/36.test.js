...
ava_1.default('issue 36 - promises returning object with properties', function (t) { return __awaiter(_this, void 0, void 0, function () {
    var emptyFetch, now, result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                emptyFetch = index_1.Substitute.for();
                now = new Date();
                emptyFetch.getUpdates(null).returns(Promise.resolve({
                    serverCheck: now,
                    data: { a: [1] }
                }));
                return [4 /*yield*/, emptyFetch.getUpdates(null)];
            case 1:
                result = _a.sent();
...
//# sourceMappingURL=36.test.js.map